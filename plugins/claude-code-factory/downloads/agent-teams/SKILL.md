# --- agentskill.sh ---
# slug: neversight/agent-teams
# owner: NeverSight
# contentSha: d9d082e
# installed: 2026-03-16T15:02:41.071Z
# source: https://agentskill.sh/neversight/agent-teams
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback neversight/agent-teams <1-5> [optional comment]
